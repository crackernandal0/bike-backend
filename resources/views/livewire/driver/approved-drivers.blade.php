...
@section('approved_drivers_active', 'active')
<div>
    <!-- Content wrapper -->
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Approved Drivers</h4>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th style="font-size: 11px;white-space:nowrap">Duty Status</th>
                                <th style="font-size: 11px;white-space:nowrap">Account Status</th>
                                        ...
                                        <td>
                                            @if ($user->account_status == 1)
                                                <button
                                                    ...
                                                    wire:click="changeAccountStatus({{ $user->id }},0)"
                                            ...
                                            @elseif($user->account_status == 0)
                                                <button
                                                    wire:confirm="Are you sure you want to change the status of this record?"
                                                    wire:click="changeAccountStatus({{ $user->id }},1)"
                                                    data-bs-toggle="tooltip" data-bs-offset="0,4"
                                                    data-bs-placement="top" data-bs-html="true" title=""
                                                    data-bs-original-title="<i class='bx bx-edit-alt bx-xs' ></i> <span>Tap To Change Status</span>"
                                            ...
                                            <div class="dropdown dropup">
                                                ...
                                                <div class="dropdown-menu" data-popper-placement="top-start">
                                                    <button class="dropdown-item"
                                                        wire:click="editDriver({{ $user->id }})">
                                                        <i class="bx bx-pencil me-1"></i> Edit
                                                    </button>
                                                    <button class="dropdown-item"
                                                        wire:click="deleteDriver({{ $user->id }})">
