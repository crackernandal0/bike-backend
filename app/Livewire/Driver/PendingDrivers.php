...
class PendingDrivers extends Component
{
    ...
    public function render()
    {
        ...
        $driver = Driver::query()->where('status', 'pending')->where('role', '!=', 'instructor');
        ...
        return view('livewire.driver.pending-drivers', compact('drivers', 'vehicleTypes', 'vehicleSubcategories'));
    }
