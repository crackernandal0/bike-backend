...
class SosContactController extends Controller
{
    public function sosContacts()
    {
        ...
        $contacts = SosContact::where('driver_id', $userId)->latest()->get();
    ...
    public function shareLocation(Request $request)
    {
        ...
        $message = "{$user->full_name} shared their live location with you at: {$request->address}. 
        ...
        if ($user && $user->fcm_token) {
            ...
            $title = "{$user->full_name} shared their live location";
            $body = $message;
